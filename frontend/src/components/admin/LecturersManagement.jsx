    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: "#ffffff", padding: "15px 20px", borderRadius: "12px", border: "1px solid #e2e8f0", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <h2 style={{ fontSize: "1.3rem", fontWeight: "700", color: "#0f172a", margin: 0 }}>Nhân sự & Giảng viên</h2>
        </div>
        <div style={{ display: "flex", gap: "10px" }}>
          ...
          <button style={{ ...styles.btn, background: "#7c3aed", display: "flex", alignItems: "center", gap: "6px" }} onClick={() => openLecturerModal()}>
