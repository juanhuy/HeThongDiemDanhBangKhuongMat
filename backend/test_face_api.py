...
def run_tests():
    ...
    res = requests.post(BASE_URL + "/", json=student_payload)
    ...
    res = requests.post(f"{BASE_URL}/{TEST_STUDENT_ID}/faces", files=files)
    ...
    res = requests.get(f"{BASE_URL}/{TEST_STUDENT_ID}/faces")
    ...
    res = requests.delete(f"{BASE_URL}/{TEST_STUDENT_ID}/faces")
