...
CREATE TABLE attendance_records (
    ...
    CONSTRAINT uc_session_student UNIQUE (session_id, student_id),                         -- Đảm bảo 1 sinh viên chỉ có 1 dòng điểm danh cho 1 tiết học (Không thể điểm danh 2 lần)
...
CREATE TABLE face_features (
    ...
    model_version VARCHAR(50) DEFAULT 'buffalo_l', -- Lưu phiên bản mô hình FaceNet (Để tương thích khi nâng cấp sau này)
